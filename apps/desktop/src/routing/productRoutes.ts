...
export const productRoutes: readonly ProductRouteDefinition[] = [
  ...
  route({
    ...
    path: "/my-strategies",
    legacyPaths: [],
    labelKey: "My strategies",
    pageTitleKey: "My strategies",
    descriptionKey: "Compose rules from the factor library, save them here, and replay them on real or synthetic history. Specs are data — deterministic, explainable, never advice.",
    icon: "review",
    navigationSection: "work",
    navigationGroup: null,
    navigationOrder: 36,
  ...
  route({
    id: "strategy_simulation",
    path: "/strategy-simulation",
    legacyPaths: [],
    labelKey: "Strategy Simulation",
    pageTitleKey: "Strategy Simulation",
    descriptionKey: "A fixed, versioned teaching strategy runs on its own synthetic-market account, fully independent of your recorded investments.",
    icon: "review",
    navigationSection: "work",
    navigationGroup: null,
    navigationOrder: 35,
