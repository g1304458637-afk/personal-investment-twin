...
export interface RuntimeAllocationPosition { instrument_id: string; display_name: string; quantity: number | null; market_value: number; weight: number | null; as_of: string | null }
