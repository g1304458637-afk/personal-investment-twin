...
from src.episodes.position_episode import PositionEpisodeLifecycle, build_position_episode_lifecycle
...
def build_episode_when_market_ready(
    ...
    *,
    ...
    availability = resolve_market_data_requirements(bundle, facts)
